...
public class Sprite {
    ...
    public Sprite(Context context, int x, int y, int imageName, int sizeX, int sizeY) {
        this.xPosition = x;
        this.yPosition = y;
        this.image = Bitmap.createScaledBitmap(BitmapFactory.decodeResource(context.getResources(), imageName), sizeX, sizeY, true);
